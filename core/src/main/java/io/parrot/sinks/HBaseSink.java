...
/**
 * This Bean Component ha il compito di processare i messaggi che
 * rappresentano un evento in Input al servizio in fase di scodamento da Kafka.
 * 
 * <ul>
 * <li>Il messaggio in Input è un <b>GalileoEvent</b></li>
 * <li>Il messaggio in Output è un <b>GalileoEvent</b></li>
 * </ul>
 * 
 * @author Matteo Capitanio <matteo.capitanio@cdp.it>
 */
public class HBaseSink implements Processor {
